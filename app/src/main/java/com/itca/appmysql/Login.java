...
public class Login extends AppCompatActivity {
    ...
    TextView viewtipo;
    public static String tipostatic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewtipo = findViewById(R.id.ethomnombre);
        btnLog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(usu.length() == 0){
                    ...
                    login(Login.this, usuario1, mantener, view);
 ...
 /*   public void consultar (){
        String url="https://javiergamezsis12a.000webhostapp.com/sw/login.php?=usuario"+etuser.getText().toString()+"&clave="+etclave.getText().toString();
        JsonArrayRequest reque = new JsonArrayRequest(Request.Method.POST, url, null, new Response.Listener<JSONArray>() {
            @Override
            public void onResponse(JSONArray response) {
                ...
                if (response.length()==1){
                    try {
                        ...
                        viewtipo.setText(jsonObject.getString("tipo"));
                        Intent intent = new Intent(getApplicationContext(), MainActivity.class);
                        intent.putExtra(String.valueOf(MainActivity.tipo), jsonObject.getString("tipo"));
    ...
    public void login(final Context context, dto_user usuario, Switch mantener, View v) {
        String url = "https://javiergamezsis12a.000webhostapp.com/sw/login.php";
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if(requestJSON.has("mensaje") == false){
                        ...
                        String apellidos = requestJSON.getString("apellidos");




                        Intent nueva = new Intent(Login.this, MainActivity.class);
                        nueva.putExtra("tipo", tipo);
                        nueva.putExtra("usuario", usuario);
                        nueva.putExtra("nombre", nombre);
                        nueva.putExtra("apellidos", apellidos);
                        startActivity(nueva);
